  ...
  var content = arr
    ...
    .map((item) => {
      ...
      <div class="textcolumn">
          ...
          ${item['abstract'] ? `[  <a  style="color:#268fd6;" class="collapsible">abstract&nbsp;</a> ] <div class="abstract rounded-corner"> <p> ${item['abstract']}  </p>` : ``} 
          ${item['cite'] && item['citelink'] ? `&nbsp; cite by <a href="${item['citelink']}">${item['cite']}</a>` : ``}
          </div>
      </div>
  </div>
  </li>
